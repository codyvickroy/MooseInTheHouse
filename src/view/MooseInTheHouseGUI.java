...
//dnd functionality libraries:


//DragPanel, MouseAdapter, LabelTransferHandler by MDF

public class MooseInTheHouseGUI extends JPanel{
   //Define the panels needed to hold the cards, and houses
   DragPanel c1cardPanel = new DragPanel();
   DragPanel c1housePanel = new DragPanel();
   DragPanel c2cardPanel = new DragPanel();
   DragPanel c2housePanel = new DragPanel();
   DragPanel c3cardPanel = new DragPanel();
   DragPanel c3housePanel = new DragPanel();
   DragPanel pcardPanel = new DragPanel();
   DragPanel phousePanel = new DragPanel();
   DragPanel deckPanel = new DragPanel();
   
   //generic listeners to be used later
   ...
   public MooseInTheHouseGUI (){
      ...
      c1cardPanel.setBackground(new Color(135, 135, 126));
      c1housePanel.setBackground(new Color(135, 135, 126));
      c2cardPanel.setBackground(new Color(135, 135, 126));
      c2housePanel.setBackground(new Color(135, 135, 126));
      c3cardPanel.setBackground(new Color(135, 135, 126));
      c3housePanel.setBackground(new Color(135, 135, 126));
      pcardPanel.setBackground(new Color(135, 135, 126));
      phousePanel.setBackground(new Color(135, 135, 126));
      deckPanel.setBackground(new Color(135, 135, 126));
      ...
      playercard1 = new JLabel(new ImageIcon("back1.png"));
      playercard2 = new JLabel(new ImageIcon("back.png"));
      playercard3 = new JLabel(new ImageIcon("back.png"));
      playercard4 = new JLabel(new ImageIcon("back.png"));
...
//       c2cardPanel.addMouseListener(handler);
   ...
   public void display()
   {
      ...
      mithFrame.setPreferredSize(new Dimension(900,900));
