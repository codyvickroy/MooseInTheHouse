...
public class MooseInTheHouseGUI extends JPanel implements CardObserver {
    ...
    public MooseInTheHouseGUI (){
        ...
        int p1score = players[0].getPoints();
        int p2score = players[1].getPoints();
        int p3score = players[2].getPoints();
        int p4score = players[3].getPoints();
        ...
        c2card1.setBorder(BorderFactory.createEmptyBorder(75, 0, 5, 0));
        ...
        c3card1.setBorder(BorderFactory.createEmptyBorder(75, 0, 5, 0));
